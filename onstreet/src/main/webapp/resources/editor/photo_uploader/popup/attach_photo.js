    ...
    function html5Upload() {	
    	...
    	sUploadURL ='/onstreet/resources/editor/file_uploader_html5.jsp'
    	//파일을 하나씩 보내고, 결과를 받음.
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 	    	...
 	    	sUrl : '/onstreet/resources/editor//file_uploader.jsp',
 	    	sCallback : '/resources/editor/photo_uploader/callback.html',
